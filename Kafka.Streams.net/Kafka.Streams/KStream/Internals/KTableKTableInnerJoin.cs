...
class KTableKTableInnerJoin<K, R, V1, V2> : KTableKTableAbstractJoin<K, R, V1, V2> {
    ...
    private  KeyValueMapper<K, V1, K> keyValueMapper = (key, value) -> key;
    ...
    private class KTableKTableJoinProcessor : AbstractProcessor<K, Change<V1>> {
        ...
        public void process( K key,  Change<V1> change) {
            ...
            R oldValue = null;
             ...
             ValueAndTimestamp<V2> valueAndTimestampRight = valueGetter.get(key);
    ...
    private class KTableKTableInnerJoinValueGetter implements KTableValueGetter<K, R> {
        ...
        public ValueAndTimestamp<R> get( K key) {
            ...
            if (value1 != null) {
                 ValueAndTimestamp<V2> valueAndTimestamp2 = valueGetter2.get(keyValueMapper.apply(key, value1));

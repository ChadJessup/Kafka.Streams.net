...
//            props.Set(StreamsConfigPropertyNames.CacheMaxBytesBuffering, (1024 * 10).ToString());
//            props.Set(StreamsConfigPropertyNames.COMMIT_INTERVAL_MS_CONFIG, 5000.ToString());
...
//            IKStream<string, long> countStream = mappedStream.GroupByKey().Count(Materialized.With(Serdes.String(), Serdes.Long())).ToStream();
...
//                      JoinWindows.Of(FromMilliseconds(5000)),
//                      Joined.With(Serdes.String(), Serdes.String(), Serdes.Long()))
//                .To(JOINED_TOPIC);

//            streamsConfiguration.Set(StreamsConfigPropertyNames.TOPOLOGY_OPTIMIZATION, optimizationConfig);
...
//            if (optimizationConfig.Equals(StreamsConfigPropertyNames.OPTIMIZE))
//            {

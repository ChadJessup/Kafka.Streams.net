...
//        private IKStream<string, long> stream;
...
//            streamsConfiguration.Set(StreamsConfigPropertyNames.BootstrapServers, null);// CLUSTER.bootstrapServers());
//            streamsConfiguration.Set(StreamsConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
//            streamsConfiguration.Set(StreamsConfigPropertyNames.STATE_DIR_CONFIG, TestUtils.GetTempDirectory());
//            streamsConfiguration.Set(StreamsConfigPropertyNames.CacheMaxBytesBuffering, 0.ToString());
//            streamsConfiguration.Set(StreamsConfigPropertyNames.COMMIT_INTERVAL_MS_CONFIG, 100.ToString());
...
//                    var result = new Dictionary<string, ValueAndTimestamp<string>>();
...
//            IReadOnlyKeyValueStore<long, ValueAndTimestamp<string>> replicatedStoreWithTimestamp =
...
//            IReadOnlyKeyValueStore<long, ValueAndTimestamp<string>> timestampedStore =
//                kafkaStreams.store(globalStore, QueryableStoreTypes.TimestampedKeyValueStore);

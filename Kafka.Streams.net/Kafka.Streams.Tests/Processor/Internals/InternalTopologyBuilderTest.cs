...
//                    Stores.PersistentWindowStore("store1", FromSeconds(30L), FromSeconds(10L), false),
//                    Serdes.String(),
//                    Serdes.String()
//                ),
//                "processor"
...
//                            Stores.PersistentSessionStore("store2", FromSeconds(30)), Serdes.String(), Serdes.String()
//                    ),
//                    "processor"
//            );
//            Dictionary<int, InternalTopologyBuilder.TopicsInfo> topicGroups = builder.topicGroups();
...
//            Field updatedTopicsField = subscriptionUpdates.GetType().getDeclaredField("updatedTopicSubscriptions");

...
//        private HashSet<TopicPartition> topicPartitions = new HashSet<TopicPartition>();
////        private ProcessorTopology topology = ProcessorTopologyFactories.WithLocalStores(
////            Arrays.asList(
////                new MockKeyValueStoreBuilder(storeName1, false).Build(),
...
//        private MockRestoreConsumer<int, int> restoreStateConsumer = new MockRestoreConsumer<int, int>(

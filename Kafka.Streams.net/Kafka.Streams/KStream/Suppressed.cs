...
public interface Suppressed<K> : NamedOperation<Suppressed<K>> {
     ...
     */
    interface StrictBufferConfig : BufferConfig<StrictBufferConfig> {
     ...
     */
    interface EagerBufferConfig : BufferConfig<EagerBufferConfig> {

    }

    interface BufferConfig<BC : BufferConfig<BC>> {
        /**

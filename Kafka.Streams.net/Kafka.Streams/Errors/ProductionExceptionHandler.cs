 ...
 */
public interface ProductionExceptionHandler : Configurable {
    /**
     ...
     */
    ProductionExceptionHandlerResponse handle( ProducerRecord<byte[], byte[]> record,
                                               Exception exception);
    ...
    enum ProductionExceptionHandlerResponse {
        ...
        ProductionExceptionHandlerResponse( int id,
                                            string name) {
            this.id = id;
            this.name = name;
        }

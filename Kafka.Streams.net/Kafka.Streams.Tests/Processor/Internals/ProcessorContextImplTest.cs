...
//        private List<IKeyValueIterator<IWindowed<string>, IValueAndTimestamp<long>>> timestampedIters = new List<IKeyValueIterator<IWindowed<string>, IValueAndTimestamp<long>>>(7);

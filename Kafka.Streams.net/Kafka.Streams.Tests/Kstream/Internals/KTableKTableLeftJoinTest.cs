...
//            // left: X0:0 (ts: 5), X1:1 (ts: 6)
//            // right:
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("X0+null", null), 5),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("X1+null", null), 6));
...
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XX2+null", null), 7),
//                new KeyValueTimestamp<string, string>(3, new Change<string>("XX3+null", null), 7));
...
//            // left: XX0:0 (ts: 7), XX1:1 (ts: 7), XX2:2 (ts: 7), XX3:3 (ts: 7)
//            // right: YY0:0 (ts: 0), YY1:1 (ts: 5), YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XX0+YY0", null), 7),
...
//            // left: XXX0:0 (ts: 6), XXX1:1 (ts: 6), XXX2:2 (ts: 6), XXX3:3 (ts: 6)
//            // right: YY0:0 (ts: 0), YY1:1 (ts: 5), YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXX0+YY0", null), 6),
...
//            // left: XXX0:0 (ts: 6), XXX1:1 (ts: 6), XXX2:2 (ts: 6), XXX3:3 (ts: 6)
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXX0+null", null), 6),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XXX1+null", null), 7));
...
//            // left: XXXX0:0 (ts: 13), XXXX1:1 (ts: 13), XXXX2:2 (ts: 13), XXXX3:3 (ts: 13)
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXXX0+null", null), 13),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XXXX1+null", null), 13),
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XXXX2+YY2", null), 13),
...
//            // left:
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>(null, null), 0),
//                new KeyValueTimestamp<string, string>(1, new Change<string>(null, null), 42),
//                new KeyValueTimestamp<string, string>(2, new Change<string>(null, null), 10),
...
//            // left: XX0:0 (ts: 7), XX1:1 (ts: 7), XX2:2 (ts: 7), XX3:3 (ts: 7)
//            // right: Y0:0 (ts: 0), Y1:1 (ts: 10)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XX0+Y0", "X0+Y0"), 7),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XX1+Y1", "X1+Y1"), 10),
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XX2+null", null), 7),
//                new KeyValueTimestamp<string, string>(3, new Change<string>("XX3+null", null), 7));
...
//            // left: XX0:0 (ts: 7), XX1:1 (ts: 7), XX2:2 (ts: 7), XX3:3 (ts: 7)
//            // right: YY0:0 (ts: 0), YY1:1 (ts: 5), YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XX0+YY0", "XX0+Y0"), 7),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XX1+YY1", "XX1+Y1"), 7),
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XX2+YY2", "XX2+null"), 10),
//                new KeyValueTimestamp<string, string>(3, new Change<string>("XX3+YY3", "XX3+null"), 15));
//            // push All four items to the primary stream. this should produce four items.
//            foreach (var expectedKey in expectedKeys)
//            {
//                driver.PipeInput(recordFactory.Create(topic1, expectedKey, "XXX" + expectedKey, 6L));
...
//            // left: XXX0:0 (ts: 6), XXX1:1 (ts: 6), XXX2:2 (ts: 6), XXX3:3 (ts: 6)
//            // right: YY0:0 (ts: 0), YY1:1 (ts: 5), YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXX0+YY0", "XX0+YY0"), 6),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XXX1+YY1", "XX1+YY1"), 6),
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XXX2+YY2", "XX2+YY2"), 10),
//                new KeyValueTimestamp<string, string>(3, new Change<string>("XXX3+YY3", "XX3+YY3"), 15));
...
//            // left: XXX0:0 (ts: 6), XXX1:1 (ts: 6), XXX2:2 (ts: 6), XXX3:3 (ts: 6)
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXX0+null", "XXX0+YY0"), 6),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XXX1+null", "XXX1+YY1"), 7));
...
//            // left: XXXX0:0 (ts: 13), XXXX1:1 (ts: 13), XXXX2:2 (ts: 13), XXXX3:3 (ts: 13)
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>("XXXX0+null", "XXX0+null"), 13),
//                new KeyValueTimestamp<string, string>(1, new Change<string>("XXXX1+null", "XXX1+null"), 13),
//                new KeyValueTimestamp<string, string>(2, new Change<string>("XXXX2+YY2", "XXX2+YY2"), 13),
//                new KeyValueTimestamp<string, string>(3, new Change<string>("XXXX3+YY3", "XXX3+YY3"), 15));
//            // push four items to the primary stream with null. this should produce four items.
//            driver.PipeInput(recordFactory.Create(topic1, expectedKeys[0], null, 0L));
//            driver.PipeInput(recordFactory.Create(topic1, expectedKeys[1], null, 42L));
//            driver.PipeInput(recordFactory.Create(topic1, expectedKeys[2], null, 5L));
...
//            // left:
//            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
//            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>(null, "XXXX0+null"), 0),
//                new KeyValueTimestamp<string, string>(1, new Change<string>(null, "XXXX1+null"), 42),
//                new KeyValueTimestamp<string, string>(2, new Change<string>(null, "XXXX2+YY2"), 10),
//                new KeyValueTimestamp<string, string>(3, new Change<string>(null, "XXXX3+YY3"), 20));
//        }
...
//            ValueMapper<string, string> mapper = value => value.toUppercase(Locale.ROOT);
...
//            var join = new KTableKTableLeftJoin<>(
//                builder.Table("left", Consumed.With(Serdes.String(), Serdes.String())),

...
//        private AssignedStreamsTasks<byte[], byte[]> active;
...
//        private AbstractTaskCreator<StreamTask<K, V>> taskCreator;
...
//                    StreamThread.AbstractTaskCreator<StreamTask<K, V>> taskCreator,
...
//            foreach (StreamTask<K, V> task in taskCreator.createTasks(consumer, newTasks))
//            {
...
//                        if (new DirectoryInfo(dir, StateManagerUtil.CHECKPOINT_FILE_NAME).exists())
//                        {
//                            tasks.Add(id);
//                        }
//                    }
...
//        public StreamTask<K, V> activeTask<K, V>(TopicPartition partition)
//        {
...
//        public Dictionary<TaskId, StreamTask<K, V>> activeTasks<K, V>()
//        {

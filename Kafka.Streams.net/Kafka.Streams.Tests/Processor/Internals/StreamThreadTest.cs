...
//        private readonly string stateDir = TestUtils.GetTempDirectory().getPath();
...
//                mkEntry(StreamsConfig.STATE_DIR_CONFIG, TestUtils.GetTempDirectory().FullName),
...
//        config.setProperty(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, Serdes.Int().GetType().FullName);

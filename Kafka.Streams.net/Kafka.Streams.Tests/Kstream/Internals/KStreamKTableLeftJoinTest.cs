...
//            pushToStream(2, "X");
//            processor.CheckAndClearProcessResult(new KeyValueTimestamp<int, string>(0, "X0+null", 0),
//                    new KeyValueTimestamp<int, string>(1, "X1+null", 1));
//        }
...
//            pushToStream(4, "X");
//            processor.CheckAndClearProcessResult(new KeyValueTimestamp<int, string>(0, "X0+Y0", 0),
//                    new KeyValueTimestamp<int, string>(1, "X1+Y1", 1),
//                    new KeyValueTimestamp<int, string>(2, "X2+null", 2),
//                    new KeyValueTimestamp<int, string>(3, "X3+null", 3));
...
//            // push All four items to the primary stream. this should produce four items.
//            pushToStream(4, "X");
//            processor.CheckAndClearProcessResult(new KeyValueTimestamp<int, string>(0, "X0+YY0", 0),
//                    new KeyValueTimestamp<int, string>(1, "X1+YY1", 1),
//                    new KeyValueTimestamp<int, string>(2, "X2+YY2", 2),
//                    new KeyValueTimestamp<int, string>(3, "X3+YY3", 3));
...
//            processor.CheckAndClearProcessResult(new KeyValueTimestamp<int, string>(0, "X0+Y0", 0),
//                    new KeyValueTimestamp<int, string>(1, "X1+Y1", 1),
//                    new KeyValueTimestamp<int, string>(2, "X2+Y2", 2),
//                    new KeyValueTimestamp<int, string>(3, "X3+Y3", 3));
...
//            // push All four items to the primary stream. this should produce four items.
//            pushToStream(4, "XX");
//            processor.CheckAndClearProcessResult(new KeyValueTimestamp<int, string>(0, "XX0+null", 0),
//                    new KeyValueTimestamp<int, string>(1, "XX1+null", 1),
//                    new KeyValueTimestamp<int, string>(2, "XX2+Y2", 2),
//                    new KeyValueTimestamp<int, string>(3, "XX3+Y3", 3));
//        }

...
//            adminConfig.Set(StreamsConfigPropertyNames.BootstrapServers, CLUSTER.bootstrapServers());
//            adminClient = Admin.Create(adminConfig);

//            StreamsConfig streamsConfiguration = new StreamsConfig();
//            streamsConfiguration.Set(StreamsConfigPropertyNames.ApplicationId, APPLICATION_ID);
//            streamsConfiguration.Set(StreamsConfigPropertyNames.COMMIT_INTERVAL_MS_CONFIG, PURGE_INTERVAL_MS);
//            streamsConfiguration.Set(StreamsConfigPropertyNames.BootstrapServers, CLUSTER.bootstrapServers());
//            streamsConfiguration.Set(StreamsConfigPropertyNames.DefaultKeySerdeClass, Serdes.Int().GetType().FullName);
//            streamsConfiguration.Set(StreamsConfigPropertyNames.DefaultValueSerdeClass, Serdes.Int().GetType().FullName);
//            streamsConfiguration.Set(StreamsConfigPropertyNames.STATE_DIR_CONFIG, TestUtils.GetTempDirectory(APPLICATION_ID).getPath());

namespace Kafka.Streams.Tests.Integration
{
    ...
    */
    ...
    {// throws InterruptedException
        ...
        stream.groupByKey()
                .reduce(
                    ...
                    Materialized<int, int, KeyValueStore<Bytes, byte[]>>.As("reduce-store").withLoggingDisabled());
    ...
    {// throws InterruptedException, ExecutionException
        ...
        StoreBuilder<KeyValueStore<int, int>> storeBuilder = new KeyValueStoreBuilder<>(lruMapSupplier,
                                                                                                      Serdes.Int(),
                                                                                                      Serdes.Int(),
                                                                                                      CLUSTER.time)
                .withLoggingDisabled();

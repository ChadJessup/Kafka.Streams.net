...
//                new KeyValueTimestamp<int, string>(0, "K0+l0", 2000),
//                new KeyValueTimestamp<int, string>(1, "K1+l1", 2001),
//                new KeyValueTimestamp<int, string>(2, "K2+l2", 2002));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "L0+l0", 2000),
//                new KeyValueTimestamp<int, string>(1, "L1+l1", 2001),
//                new KeyValueTimestamp<int, string>(2, "L2+l2", 2002),
//                new KeyValueTimestamp<int, string>(3, "L3+l3", 2003));
//        }
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+c0", 1001),
//                new KeyValueTimestamp<int, string>(1, "A1+c1", 1001));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+d0", 1002),
//                new KeyValueTimestamp<int, string>(1, "A1+d1", 1002),
//                new KeyValueTimestamp<int, string>(2, "A2+d2", 1002));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+e0", 1003),
//                new KeyValueTimestamp<int, string>(1, "A1+e1", 1003),
//                new KeyValueTimestamp<int, string>(2, "A2+e2", 1003),
//                new KeyValueTimestamp<int, string>(3, "A3+e3", 1003));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+f0", 1100),
//                new KeyValueTimestamp<int, string>(1, "A1+f1", 1100),
//                new KeyValueTimestamp<int, string>(2, "A2+f2", 1100),
//                new KeyValueTimestamp<int, string>(3, "A3+f3", 1100));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(1, "A1+g1", 1101),
//                new KeyValueTimestamp<int, string>(2, "A2+g2", 1101),
//                new KeyValueTimestamp<int, string>(3, "A3+g3", 1101));
...
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(2, "A2+h2", 1102),
//                new KeyValueTimestamp<int, string>(3, "A3+h3", 1102));
...
//            Assert.Equal(new List<string> { topic1, topic2 }, CopartitionGroups.GetEnumerator().Current);
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+c0", 1000),
//                new KeyValueTimestamp<int, string>(1, "A1+c1", 1001));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+d0", 1000),
//                new KeyValueTimestamp<int, string>(1, "A1+d1", 1001),
//                new KeyValueTimestamp<int, string>(2, "A2+d2", 1002));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+e0", 1000),
//                new KeyValueTimestamp<int, string>(1, "A1+e1", 1001),
//                new KeyValueTimestamp<int, string>(2, "A2+e2", 1002),
//                new KeyValueTimestamp<int, string>(3, "A3+e3", 1003));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(0, "A0+f0", 1000),
//                new KeyValueTimestamp<int, string>(1, "A1+f1", 1001),
//                new KeyValueTimestamp<int, string>(2, "A2+f2", 1002),
//                new KeyValueTimestamp<int, string>(3, "A3+f3", 1003));
...
//            }
//            processor.CheckAndClearProcessResult(
//                new KeyValueTimestamp<int, string>(1, "A1+g1", 1001),
//                new KeyValueTimestamp<int, string>(2, "A2+g2", 1002),
//                new KeyValueTimestamp<int, string>(3, "A3+g3", 1003));

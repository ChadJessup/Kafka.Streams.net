...
//                        return key switch
//                        {
//                            "null" => KeyValuePair.Create<string, string>(null, value),
//                            "NULL" => null,
//                            _ => KeyValuePair.Create(value, value),
//                        };
//                    },
//                stringSerialized)
//            .Aggregate(
...
//                .GroupBy(MockMapper.GetSelectValueKeyValueMapper(), stringSerialized)
...
//                    ApplicationId = "test",
//                    StateStoreDirectory = TestUtils.GetTempDirectory("kafka-test"),
//                },
//                DateTime.MinValue);

    ...
    public class KTableKTableInnerJoinTest
    {
        ...
        public void testSendingOldValues()
        {
            ...
            proc.CheckAndClearProcessResult(
                new KeyValueTimestamp<string, string>(0, new Change<string>("XX0+YY0", "XX0+Y0"), 7),
            ...
            // right: YY0:0 (ts: 0), YY1:1 (ts: 5), YY2:2 (ts: 10), YY3:3 (ts: 15)
            proc.CheckAndClearProcessResult(
                new KeyValueTimestamp<string, string>(0, new Change<string>("XXX0+YY0", "XX0+YY0"), 6),
            ...
            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(0, new Change<string>(null, "XXX0+YY0"), 6),
                new KeyValueTimestamp<string, string>(1, new Change<string>(null, "XXX1+YY1"), 7));
            // push All four items to the primary stream. this should produce two items.
            foreach (var expectedKey in expectedKeys)
            {
            ...
            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(2, new Change<string>("XXXX2+YY2", "XXX2+YY2"), 13),
            ...
            // left:
            // right: YY2:2 (ts: 10), YY3:3 (ts: 15)
            proc.CheckAndClearProcessResult(new KeyValueTimestamp<string, string>(2, new Change<string>(null, "XXXX2+YY2"), 10),

            ...
            foreach (String attrval in attrvals)
{
    ...
    public static Properties loadProps(String filename) throws IOException {
        ...
        if (filename != null)
{
            try (InputStream propStream = Files.newInputStream(Paths[filename)))
{
        ...
        } catch (IOException outer)
{
            try {
                ...
                log.LogDebug("Non-atomic move of {} to {} succeeded after atomic move failed due to {}", source, target,
                        outer.getMessage());
            ...
            } catch (Throwable t)
{
                ...
                log.LogError("Failed to close {} with type {}", name, closeable.getClass().getName(), t);
            }
        }
    }
        ...
        if (size < 0)
{
     ...
     *
     * @throws ArgumentException If position is negative

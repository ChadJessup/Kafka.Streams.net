...
//        {
//            IConsumer consumer = mockConsumer(new AuthorizationException("blah"));
...
//        private AbstractTask CreateTask(IConsumer consumer, Dictionary<IStateStore, string> stateStoresToChangelogTopics)
//        {

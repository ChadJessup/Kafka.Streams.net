...
//        {
//            List<KeyValuePair<byte[], byte[]>> actual = new List<KeyValuePair<byte[], byte[]>>();
//            IStateRestoreCallback callback = (key, value) => actual.Add(KeyValuePair.Create(key, value));
...
//            {
//                ConsumeResult<byte[], byte[]> actual1 = actual.ElementAt(i);
//                ConsumeResult<byte[], byte[]> expected1 = expected.ElementAt(i);
